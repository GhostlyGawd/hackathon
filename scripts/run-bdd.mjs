...
await mkdir(
  path.join(repositoryRoot, "artifacts", "verification", "VAL-01", "reports"),
  { recursive: true },
);
await mkdir(
  path.join(
...
await mkdir(
  path.join(repositoryRoot, "artifacts", "verification", "RUN-02", "reports"),
  { recursive: true },
);
await mkdir(
  path.join(repositoryRoot, "artifacts", "verification", "RUN-02", "screenshots"),
  { recursive: true },
);
await mkdir(
  path.join(repositoryRoot, "artifacts", "verification", "RUN-02", "traces"),
  { recursive: true },
);

await mkdir(
  path.join(repositoryRoot, "artifacts", "verification", "RUN-03", "reports"),
  { recursive: true },
);
await mkdir(
  path.join(repositoryRoot, "artifacts", "verification", "RUN-03", "screenshots"),
  { recursive: true },
);
await mkdir(
  path.join(repositoryRoot, "artifacts", "verification", "RUN-03", "traces"),
  { recursive: true },
);

await mkdir(
  path.join(repositoryRoot, "artifacts", "verification", "RUN-04", "reports"),
  { recursive: true },
);
await mkdir(
  path.join(repositoryRoot, "artifacts", "verification", "RUN-04", "screenshots"),
  { recursive: true },
);
await mkdir(
...
await mkdir(
  path.join(repositoryRoot, "artifacts", "verification", "JRN-03", "traces"),
  { recursive: true },
);

await mkdir(
  path.join(repositoryRoot, "artifacts", "verification", "JRN-02", "reports"),
  { recursive: true },
);
await mkdir(
  path.join(
