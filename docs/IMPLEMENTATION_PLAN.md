...
| FND-03 | P0 | FND-01, FND-02 | Domain schemas, state machines, migrations | IN PROGRESS |
...
- **Status:** IN PROGRESS — focused and full local verification are green; clean-checkout Ubuntu and Windows CI are pending.
