...
| RUN-01 | P0 | AUT-03, AUT-04, FIX-01 | Isolated browser runner | IN PROGRESS |
...
- **Status:** IN PROGRESS — TDD scope covers per-run Chromium processes/contexts, exact-origin navigation and host egress, service-worker blocking, popup policy, isolated or blocked downloads/clipboard, terminal cleanup, renderer crash recovery, and cross-run resource invariants.
